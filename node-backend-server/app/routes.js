...
module.exports = function (app) {
	...
	app.post('/register', loginOperation.resister.bind(loginOperation));
	...
	app.put('/asset', passport.authenticate('jwt', { session: false }),authorization,assetOperation.updateStaff.bind(assetOperation));
	app.post('/asset/transfer', passport.authenticate('jwt', { session: false }),authorization,assetOperation.addStaff.bind(assetOperation));
